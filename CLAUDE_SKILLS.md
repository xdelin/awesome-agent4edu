# Claude Skills for Education & Learning / 教育与学习专用 Claude 技能库

这是一个专注于 **Claude** (特别是 Claude 3.5 Sonnet / Opus) 在教育、学习、学术研究和学生生产力方面的 Prompt (提示词) 和 Skills (技能) 集合。

[English](./CLAUDE_SKILLS_EN.md) | [中文](./CLAUDE_SKILLS.md)

## 🏫 Educational AI & Tutoring (教育辅导与教学助手)

> 专为教师、学生和教育工作者设计的通用教学技能。
...
## ✍️ Writing & Content Creation (写作与内容创作)

> 提升从创意写作到专业文案的创作质量，包含"去 AI 味"和风格化工具。
...
## 📚 Research & Academic (学术研究与论文)

> 辅助学术文献阅读、论文规划与写作的专业技能。
...
## 💻 Coding & Technical Education (编程与技术学习)

> 利用 Claude 强大的代码能力来辅助计算机科学教育。
...
## ♿ Accessibility & UX Design (无障碍与用户体验)
...
## 🧠 Productivity & Second Brain (学生生产力与第二大脑)

> 结合 Obsidian、Notion 等工具的知识管理技能。
...
## 🛠️ MCP & Meta Skills (MCP 协议与元技能)

> 高级用户技能，用于扩展 Claude 的底层能力。
...
- **[awesome-claude-skills (ponderous)](https://github.com/ponderous-dustiness314/awesome-claude-skills)**
  - **描述**: 两个高质量的同名仓库，收集了大量经过验证的 Claude Skills。包含文档处理、数据分析等。
  - **内容**: 好的技能集合源。
