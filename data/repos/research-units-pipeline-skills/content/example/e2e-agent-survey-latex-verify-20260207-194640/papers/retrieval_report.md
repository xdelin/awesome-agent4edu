...
- Workspace: `/home/rjs/Workspace/codebase/research-units-pipeline-skills/workspaces/e2e-agent-survey-latex-verify-20260207-194640`
- queries.md: `/home/rjs/Workspace/codebase/research-units-pipeline-skills/workspaces/e2e-agent-survey-latex-verify-20260207-194640/queries.md`
- Keywords: `12`
- Excludes: `5`
- Time window: ``..``
- Online retrieval (best-effort): `SKIPPED`
...
- Offline inputs: `1`
  - `/home/rjs/Workspace/codebase/research-units-pipeline-skills/workspaces/e2e-agent-survey-latex-verify-20260207-194640/papers/imports/prev_papers_raw_20260125-225035.jsonl`
- Snowball inputs: `0`
...
| route | unique_papers |
|---|---:|
| import:prev_papers_raw_20260125-225035.jsonl | 1800 |
| arxiv_query:(all:"LLM agent survey (A150++)" OR all:"LLM agent" OR all:"language model agent" OR all:"tool-using agent") | 1793 |
