...
<!-- BEGIN CHECKPOINT:C0 -->
## Kickoff — agent latex survey

- Pipeline: `pipelines/arxiv-survey-latex.pipeline.md`
- Workspace: `workspaces/e2e-agent-survey-latex-verify-20260207-194640`
- Workspace name: `e2e-agent-survey-latex-verify-20260207-194640`
