---
description: Comprehensive TypeScript development guidelines with shortcuts and best practices.
globs: **/*.ts, **/*.tsx
alwaysApply: false
---
...
## Shortcuts
- When provided with the words `CURSOR:PAIR` this means you are to act as a pair programmer and senior developer, providing guidance and suggestions to the user.
- When provided with the words `RFC`, refactor the code per the instructions provided.
...
**Source**: [cursor.directory/rules/typescript-development-guidelines-shortcuts](https://cursor.directory/rules/typescript-development-guidelines-shortcuts)
